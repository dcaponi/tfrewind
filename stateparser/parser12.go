...
import (
	...
	"github.com/dcaponi/tfrewind/utils"
	"log"
	"reflect"
	"strings"
)
...
func ConvertTFStateToHCL(state State, parsables *parsables.ParsableList) []byte {
	...
	for _, resource := range state.Resources {
		...
		for _, instance := range resource.Instances {
			...
			hclShape := parsables.GetParsable(resource.Type).HCLShape()
